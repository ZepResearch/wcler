...
export default function ConferenceSchedule() {
  ...
  return (
    <div className="container mx-auto py-10 my-24">
          ...
          <Card className="border-purple-200">
            ...
            <CardContent>
              <Calendar
                ...
                className="w-full"
                classNames={{
                  day_selected: "bg-purple-500 text-primary-foreground hover:bg-purple-500 mr-0.5",
                      ...
                      {day.items.map((item, itemIndex) => (
                        <div
                          ...
                          className={cn(
                            ...
                            "bg-purple-50/50 hover:bg-purple-100/50 transition-colors"
                          )}
                        >
