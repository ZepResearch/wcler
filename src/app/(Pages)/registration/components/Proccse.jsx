  ...
  return (
    <div className="py-12 px-4 bg-white ">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-8  underline-offset-4 ">
        ...
        <div className="grid gap-6 md:grid-cols-4">
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-gradient-to-tr from-violet-500 to-orange-300 text-primary-foreground rounded-full p-3 mb-4">
                {step.icon}
              </div>
