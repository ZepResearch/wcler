...
export default function AboutCompany() {
  ...
  const conferenceFeatures = [
    { icon: CalendarDays, text: "2-day event: October 24th - 25th, 2025" },
    { icon: MapPin, text: "Jakarta, Indonesia" },
    { icon: Users, text: "500+ Expected Attendees" },
    { icon: Globe, text: "International Speakers" },
    { icon: Mail, text: "info@wcler.org" },
          ...
          <motion.div variants={itemVariants}>
            <Card className="h-full bg-white/50 backdrop-blur-sm border-2 border-primary/20">
              ...
              <CardContent>
                ...
                Zep Research is partnership with the World Conference on Learning and Education Research, 
                  is dedicated to advancing educational excellence through research and innovation. Our mission is to create 
                  a global platform for knowledge exchange, promote evidence-based practices, and highlight emerging trends 
                  in education. By connecting researchers, educators, and professionals, we aim to inspire progress, share 
                  valuable insights, and contribute to the advancement of education worldwide. Through our conferences and 
                  research initiatives, we work to shape a more innovative and effective future for global education.
                </p>
              </CardContent>
            </Card>
          </motion.div>
