...
const SpeakerCard = ({ name, role, image, bio,collectionId, id, country, college, onMoreInfo }) => (
  ...
  >
    <img 
      src={ `https://wcler.pockethost.io/api/files/${collectionId}/${id}/${image}` } 
      alt={name} 
    ...
    <div className="p-4">
      ...
      <button
        ...
        className="mt-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-violet-600 text-white rounded hover:bg-orange-700 transition-colors duration-300"
      >
        More info
      </button>
    </div>
      ...
      <>
        ...
        >
          <div className="p-6 flex flex-col h-full">
            ...
            <img
              src={`https://wcler.pockethost.io/api/files/${speaker.collectionId}/${speaker.id}/${speaker.image}` }
              alt={speaker.name}
            ...
            <h3 className="text-xl text-gray-700 ">{speaker.role}</h3>
            ...
            <button
              onClick={onClose}
              className="mt-6 w-full px-4 py-2 bg-gradient-to-r from-blue-600 to-violet-600 text-white rounded hover:bg-orange-700 transition-colors duration-300"
            >
              Close
            </button>
          </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                activeCategory === category.id
                  ? "bg-gradient-to-r from-purple-500 via-red-400  to-orange-400 text-white shadow-md"
                  : "bg-gradient-to-br from-purple-200/80 via-red-200/80  to-orange-200/80 text-gray-900 hover:bg-orange-200"
              }`}
            >
              {category.title}
            </button>
